...
!(function(t, e) {
  ...
  function r(t, e) {
    ...
    var n = t.state;
    a(t, n, [], t._modules.root, !0), s(t, n, e);
  }
  function s(t, n, o) {
    var i = t._vm;
    t.getters = {};
  ...
  function a(t, e, n, o, i) {
    ...
    if ((o.namespaced && (t._modulesNamespaceMap[s] = o), !r && !i)) {
      var u = d(e, n.slice(0, -1)),
        l = n[n.length - 1];
      t._withCommit(function() {
        j.set(u, l, o.state);
      });
    }
    var m = (o.context = c(t, s, n));
  ...
  var j,
    C = function(e) {
      var n = this;
      void 0 === e && (e = {}),
        !j && "undefined" != typeof window && window.Vue && v(window.Vue);
      var o = e.plugins;
      void 0 === o && (o = []);
      var i = e.strict;
      void 0 === i && (i = !1);
  ...
  (E.state.get = function() {
    ...
    (C.prototype.registerModule = function(t, e) {
      "string" == typeof t && (t = [t]),
        this._modules.register(t, e),
        a(this, this.state, t, this._modules.get(t)),
        s(this, this.state);
    }),
    ...
    G = y(function(t, e) {
      ...
      return (
        _(e).forEach(function(e) {
          ...
          (i = t + i),
            (n[o] = function() {
              if (!t || g(this.$store, 0, t)) return this.$store.getters[i];
            }),
            (n[o].vuex = !0);
        }),
        n
